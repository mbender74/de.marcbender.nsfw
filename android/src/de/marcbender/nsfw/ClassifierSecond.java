...
public abstract class ClassifierSecond {
   ...
   */
  public static ClassifierSecond create(Activity activity, int numThreads)
      throws IOException {

    return new ClassifierSecondFloatMobileNet(activity, numThreads);
  }
  ...
  private List<String> loadLabelsFromAsset(String filename)
  {
    List<String> json = null;

    try {
      String url = TiUrl.resolve(TiC.URL_ANDROID_ASSET_RESOURCES, filename, null);
      ...
      String inputStr = result.toString("UTF-8");
      ...
      Log.e("TensorflowLite", "Error opening file: " + ex.getMessage());
    }
...
private MappedByteBuffer loadModelFile(Activity activity) throws IOException {
  ...
  protected ClassifierSecond(Activity activity, int numThreads) throws IOException {
    ...
    labels = loadLabelsFromAsset(getLabelPath());
  ...
  public List<Recognition> recognizeImage(final Bitmap bitmap, int sensorOrientation) {
    ...
    //Trace.endSection();
    //Log.v("TensorflowLite","Timecost to load the image: " + (endTimeForLoadImage - startTimeForLoadImage));
    ...
    //Trace.endSection();
    //Log.v("TensorflowLite","Timecost to run model inference: " + (endTimeForReference - startTimeForReference));
