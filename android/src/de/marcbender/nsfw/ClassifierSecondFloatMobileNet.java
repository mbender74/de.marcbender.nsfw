...
public class ClassifierSecondFloatMobileNet extends ClassifierSecond {
   ...
   * @param activity
   */
  public ClassifierSecondFloatMobileNet(Activity activity, int numThreads)
      throws IOException {
  ...
  protected String getModelPath() {
    return "nsfwsecond.tflite";
  }

  @Override
  protected String getLabelPath() {
    return "nsfwsecondlabels.txt";
  }
